...
class about extends CI_Controller {
	...
	public function editAboutUs()
	{
		...
		$this->parser_data['about_text_detail_eng'] =  $this->row_data['about_text_detail_eng'];
	...
	{	
		...
		$about_text_detail_eng = $this->input->post('about_text_detail_eng');
		...
		{
			if ($about_text_detail_eng == '')
				$about_text_detail_eng = 'default text';

			$update = $this->about_model->updateAboutUs($about_text_detail,$about_text_detail_eng);
