...
<div class="content-box"><!-- Start Content Box -->
             ...
             <div class="content-box-header">
				<h3> <font style="margin-left:230px;">Slider (yeni kayıt ekleme formu)</font></h3>
           		...
           		<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="1">                 
						...
						<form action="{base}backend/slider/addItem" method="post" enctype="multipart/form-data" >
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->											
                                ...
                                <p>
              					...
              					<p>
									...
									<textarea class="text-input textarea" id="textarea" name="slider_text_detail"
