	...
	<div class="container clearfix">
        ...
        <div class="content_wrapper">   
	        ...
	        <div class="content">
                ...
                <div class="clearfix article_list columns2">
                	
                  {all_acty_iteration}
                    <div class="article_item">
                    	<div class="article_image"><a href="etkinlikler/{acty_id}"><img src="{base}{acty_thumb_photo}" alt=""></a></div>
                        <div class="article_title">
                        	<h3><a href="etkinlikler/{acty_id}">{acty_title}</a></h3>
                            <span class="subtitle">Tarih : {acty_date}</span>
                        </div>
                    </div>
                  {/all_acty_iteration}  
